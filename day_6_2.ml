...
(* Bien sûr, on ne représente pas la colonie de poissons
   par la liste des poissons avec pour chacun sa date de
   reproduction, mais par un tableau donnant pour
   chaque jour de reproduction le nombre de poissons. *)
